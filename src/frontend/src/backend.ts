...
import type { UserGameStats as _UserGameStats, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMyStats(): Promise<UserGameStats | null> {
        if (this.processError) {
            try {
    ...
    async getUserStats(arg0: Principal): Promise<UserGameStats | null> {
        if (this.processError) {
            try {
    ...
    async updateMyStats(arg0: UserGameStats): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMyStats(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserGameStats]): UserGameStats | null {
    return value.length === 0 ? null : value[0];
}
